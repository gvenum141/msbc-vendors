/// <summary>
/// Installs the Vendor Watch setup and processor job queue entry.
/// </summary>
codeunit 71000 "Vendor Watch Install"
{
    ...
    var
        JobQueueDescriptionLbl: Label 'Vendor Watch Processor';
    ...
    begin
        ...
        VendorSetup."Batch Size" := 115;
        VendorSetup."Max Attempts" := 5;
        VendorSetup.Insert();
    end;
